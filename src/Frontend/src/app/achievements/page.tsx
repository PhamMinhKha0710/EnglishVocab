                ...
                <Card key={challenge.id} className="overflow-hidden">
                  <CardContent className="p-6">
                    <div className="flex flex-col md:flex-row gap-4">
                      <div className="text-4xl flex items-center justify-center md:w-16">
                        {challenge.icon}
                      </div>
                      <div className="flex-1 space-y-3">
                        <div>
                          <div className="flex items-center justify-between">
                            ...
                            <Badge className="text-xs">{challenge.deadline}</Badge>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <Badge className="bg-purple-100 text-purple-700 hover:bg-purple-200">{challenge.reward}</Badge>
              ...
              <div className="text-center">
                <Link href="/study">
                  <Button className="bg-purple-600 hover:bg-purple-700">
                    Học ngay để hoàn thành thử thách
                  </Button>
                </Link>
              </div>
            </div>
